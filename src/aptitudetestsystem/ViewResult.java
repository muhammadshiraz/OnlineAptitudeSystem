...
public class ViewResult extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RemoveComments
     */
    public ViewResult() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Topic", "Total_Marks", "Student_Mark", "Exam_Duration", "Total_Question", "Percentage"
            }
        ) {
        ...
        jLabel4.setText("Students Results");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        {
            try {
                db.rs = db.st.executeQuery("select * from Stud_Result where SR_Id = '" + searchtxt.getText() + "'");

                if(db.rs.next())
                {
                    tm.insertRow(tm.getRowCount(), new Object[]{db.rs.getString(1), db.rs.getString(2),db.rs.getString(3)
                    ,db.rs.getString(4),db.rs.getString(5),db.rs.getString(6),db.rs.getString(7)});
            }
            else{
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        {
            try {
                db.st.executeUpdate("delete from Stud_Result where SR_Id = "+searchtxt.getText() +"");

                JOptionPane.showMessageDialog(this, "Delete Student Result");
                clear();
        } catch (Exception ex) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tm.setNumRows(0);
        try {
            db.rs = db.st.executeQuery("select * from Stud_Result");
...
//            java.util.logging.Logger.getLogger(RemoveComments.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RemoveComments().setVisible(true);
//            }
//        });
//    }
