 ...
 * @author Engr_Shery
 */
public class RemoveComments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("View Students Comments");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        {
            try {
                db.rs = db.st.executeQuery("select * from TB_Comment where ID = '" + searchtxt.getText() + "'");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        {
            try {
                db.st.executeUpdate("delete from TB_Comment where ID = "+searchtxt.getText() +"");

                JOptionPane.showMessageDialog(this, "Delete Your Comments");
                clear();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tm.setNumRows(0);
        try {
            db.rs = db.st.executeQuery("select * from TB_Comment");
        ...
        {
            JOptionPane.showMessageDialog(this,"No Comments Found");
            searchtxt.requestFocus();
        }
